...
function Dissolve() {
  ...
  function step1(enabled, withDialog) {
    ...
    desc2.putEnumerated(PSKey.Mode, PSType.BlendMode, PSEnum.Dissolve);
...
Dissolve.loadSymbols(); // load up our symbols
