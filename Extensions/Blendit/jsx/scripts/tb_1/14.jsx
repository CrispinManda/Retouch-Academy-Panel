...
function HardLight() {
  ...
  function step1(enabled, withDialog) {
    ...
    desc2.putEnumerated(PSKey.Mode, PSType.BlendMode, PSEnum.HardLight);
...
//
HardLight.loadSymbols = function() {
  var dbgLevel = $.level;
  $.level = 0;
  try {
    PSConstants;
...
HardLight.loadSymbols(); // load up our symbols
