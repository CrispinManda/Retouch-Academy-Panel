...
function Lighten() {
  ...
  function step1(enabled, withDialog) {
    ...
    desc2.putEnumerated(PSKey.Mode, PSType.BlendMode, PSEnum.Lighten);
...
Lighten.loadSymbols(); // load up our symbols
