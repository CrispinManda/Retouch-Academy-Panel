...
function LinearDodge_Add() {
  ...
  function step1(enabled, withDialog) {
    ...
    desc2.putEnumerated(PSKey.Mode, PSType.BlendMode, PSString.linearDodge);
...
//
LinearDodge_Add.loadSymbols = function() {
  var dbgLevel = $.level;
  $.level = 0;
  try {
    PSConstants;
...
LinearDodge_Add.loadSymbols(); // load up our symbols



//=========================================
//                    LinearDodge_Add.main
//=========================================
//

LinearDodge_Add.main = function () {
  LinearDodge_Add();
};
