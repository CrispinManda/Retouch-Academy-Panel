...
function Saturation() {
  ...
  function step1(enabled, withDialog) {
    ...
    desc2.putEnumerated(PSKey.Mode, PSType.BlendMode, PSEnum.Saturation);
...
//
Saturation.loadSymbols = function() {
  var dbgLevel = $.level;
  $.level = 0;
  try {
    PSConstants;
...
Saturation.loadSymbols(); // load up our symbols
