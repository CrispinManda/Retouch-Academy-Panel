...
function DarkerColor() {
  ...
  function step1(enabled, withDialog) {
    ...
    desc2.putEnumerated(PSKey.Mode, PSType.BlendMode, PSString.darkerColor);
...
//
DarkerColor.loadSymbols = function() {
  var dbgLevel = $.level;
  $.level = 0;
  try {
    PSConstants;
...
DarkerColor.loadSymbols(); // load up our symbols
