...
function Subtract() {
  ...
  function step1(enabled, withDialog) {
    ...
    desc2.putEnumerated(PSKey.Mode, PSType.BlendMode, sTID("blendSubtraction"));
...
Subtract.loadSymbols(); // load up our symbols
