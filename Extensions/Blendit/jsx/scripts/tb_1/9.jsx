...
function ColorDodge() {
  ...
  function step1(enabled, withDialog) {
    ...
    desc2.putEnumerated(PSKey.Mode, PSType.BlendMode, PSEnum.ColorDodge);
...
//
ColorDodge.loadSymbols = function() {
  var dbgLevel = $.level;
  $.level = 0;
  try {
    PSConstants;
...
ColorDodge.loadSymbols(); // load up our symbols
