...
function LighterColor() {
  ...
  function step1(enabled, withDialog) {
    ...
    desc2.putEnumerated(PSKey.Mode, PSType.BlendMode, PSString.lighterColor);
...
//
LighterColor.loadSymbols = function() {
  var dbgLevel = $.level;
  $.level = 0;
  try {
    PSConstants;
...
LighterColor.loadSymbols(); // load up our symbols
