...
function PinLight() {
  ...
  function step1(enabled, withDialog) {
    ...
    desc2.putEnumerated(PSKey.Mode, PSType.BlendMode, PSString.pinLight);
...
PinLight.loadSymbols(); // load up our symbols
